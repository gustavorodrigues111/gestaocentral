  ...
  return (
    <div className="max-w-5xl">
      ...
      <div className="flex border-b border-gray-200 dark:border-gray-800 mb-4 overflow-x-auto">
        {([
          ["funcionamento", "Funcionamento + Datas especiais", CalendarDays],
          ["janelas",       `Janelas de Reserva (${saloes.filter(s => s.ativo).length} ${saloes.filter(s => s.ativo).length === 1 ? "salão" : "salões"})`, Ticket],
