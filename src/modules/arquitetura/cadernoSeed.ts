...
const SEED: Seed[] = [
  ...
  { modulo: "documentos", resp: "ia", titulo: "Fase 2 FEITA (Admissão gera termo pelo Documentos → Drive). Peça 1 FEITA: uniforme/EPI da ENTREGA já gera o termo do advogado (fábrica) nos 2 contextos + trava de C.A. Peça 2 FEITA: Documentos por cargo (Admissão → Configurações) → checklist já vem por cargo. Pendente Peça 3: puxar remuneração/atividades do cadastro do CARGO pra auto-preencher os contratos." },
