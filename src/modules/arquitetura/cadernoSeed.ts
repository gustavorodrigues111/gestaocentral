...
const SEED: Seed[] = [
  ...
  { modulo: "geral", resp: "ia", titulo: "Reorg de categorias/módulos + ícones lucide (Fase 1) FEITA: <ModuleIcon> central (emoji→lucide), categoria MINHAS INFORMAÇÕES criada, Financeiro fundido em Administrativo, área 'fin' removida, subáreas/labels renomeados. Ícones unificados em Menu/Módulos/Perfis.", descricao: "Falta Fase 2: portal split, internals de Configurações como módulos, Perfis não-master." },
  { modulo: "configuracoes", resp: "ia", titulo: "Fase 2: transformar Dados da empresa, Módulos e Perfis de Acesso em MÓDULOS dentro de CONFIGURAÇÕES (hoje são abas da ConfiguracoesPage)." },
  { modulo: "configuracoes", resp: "ia", titulo: "Perfis de Acesso deixar de ser master-only: criar ação perfisAcesso.acessar no actionCatalog + trocar o gate isMaster no Sidebar/rota /perfis. (Confirmado na reorg; hoje ainda master-only.)" },
  { modulo: "chat", resp: "ia", titulo: "Quebrar o Portal do Empregado em 6 módulos de MINHAS INFORMAÇÕES (Dashboard + Minha Escala/Meus Horários/Minhas Gorjetas/Meus Comunicados/Fale com DP), migrando as permissões portalEmpregado.* sem perder acessos. Rota /portal/:rid vira atalho pra 1ª aba disponível." },
