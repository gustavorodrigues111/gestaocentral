...
export function defaultSiteConfig(rid: string, nomeRestaurante: string): SiteConfig {
  ...
  return {
    ...
    delivery: [],
    // Tema com strings vazias por default — assim cada template renderiza
    // com SEU próprio look-and-feel. Quando o user customiza no admin,
    // sobrescreve esses defaults do template.
    tema: {
      corPrimaria: "",
      corSecundaria: "",
      corFundo: "",
