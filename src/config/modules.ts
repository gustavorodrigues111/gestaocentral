...
export const MODULES: ModuleDef[] = [
  ...
  { id: "wikiProcessos", area: "ops", subarea: "Gestão da Operação",   label: "Wiki de Processos", icon: "📚", status: "em-breve", etapa: "em_desenvolvimento", desc: "Documentação viva dos processos internos por área — texto, checklist ou passo-a-passo, com fotos. Consulta da equipe em caso de dúvida." },
  ...
  { id: "planner",     area: "planejamento", subarea: "Planner",       label: "Planner",           icon: "📅", status: "ativo", etapa: "beta",             desc: "Agenda pessoal integrada ao Google Calendar. Lança prazos de qualquer tipo (conta, técnico, trabalhista) que registram no módulo de origem." },
