...
export const MODULES: ModuleDef[] = [
  ...
  { id: "rotinas",     area: "ops", subarea: "Gestão da Operação",     label: "Rotinas e Avisos", icon: "🔔", status: "ativo", etapa: "beta",               desc: "Controle das notificações: canais (Central, email, WhatsApp), destinatários, horários e dias de cada aviso — mais rotinas recorrentes atribuídas a pessoas", dependsOn: ["pessoas"] },
  ...
  { id: "whatsappInbox", area: "ops", subarea: "Gestão da Operação",   label: "WhatsApp",        icon: "💬", status: "ativo", etapa: "em_desenvolvimento", desc: "Caixa de entrada do WhatsApp do planejamento.app: recebe e responde mensagens dos usuários (número único da plataforma)" },
