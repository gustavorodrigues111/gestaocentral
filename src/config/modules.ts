...
export const MODULES: ModuleDef[] = [
  ...
  { id: "folhas",      area: "fin", subarea: "Folha de Pagamento",     label: "Conferência de Folhas", icon: "🧾", status: "ativo", etapa: "em_desenvolvimento", desc: "Agente auditor: sobe os espelhos da folha (Senador), a IA extrai e o motor de regras confere contra gorjeta, adiantamento (verba 953) e integridade. Reporta só os erros (P0/P1/P2), não o que está certo.", dependsOn: ["pessoas", "gorjetas"] },
