...
export const MODULES: ModuleDef[] = [
  ...
  { id: "planoDeAcao", area: "planejamento", subarea: "Tarefas",       label: "Tarefas simplificadas", icon: "✅", status: "ativo", etapa: "beta",               desc: "Lente enxuta do Gestor de Tarefas — a lista simples e mobile de quem executa na operação. Concluir com um toque + andamento; líder vê as da equipe.", dependsOn: ["pessoas"] },
