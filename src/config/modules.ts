...
export const MODULES: ModuleDef[] = [
  ...
  { id: "estoqueValidade", area: "ops", subarea: "Produção & Estoque", label: "Estoques e Validades", icon: "🏷️", status: "ativo", etapa: "em_desenvolvimento", desc: "Etiquetas de validade (cozinha) + gestão de estoque por lote (locais, entrada por NF, baixa por QR, giro PVPS/PEPS). Multi-loja.", dependsOn: ["pessoas"] },
  ...
  // Não aparece mais como item próprio no menu: virou o MODO SIMPLIFICADO do
  // item único "Tarefas". Quem tem o perfil simplificado (permissão planoDeAcao)
  // abre a lente enxuta; quem tem o perfil de Gestor (permissão tarefas) abre o
  // avançado. Segue módulo ativo (rota + dependsOn de Segurança Sanitária).
  { id: "planoDeAcao", area: "planejamento", subarea: "Tarefas",       label: "Tarefas (simplificado)", icon: "✅", status: "ativo", etapa: "beta",               desc: "Modo simplificado do Gestor de Tarefas — a lista simples e mobile de quem executa na operação. É o que abre no item 'Tarefas' pra quem tem este perfil. Concluir com um toque + andamento; líder vê as da equipe.", dependsOn: ["pessoas"], oculto: true },
  ...
  { id: "wikiProcessos", area: "ops", subarea: "Gestão da Operação",   label: "Wiki de Processos", icon: "📚", status: "ativo", etapa: "em_desenvolvimento", desc: "Guias de funcionamento por área (Pessoas, Financeiro, Compras, Eventos) — um guia HTML por área + um assistente de IA que responde as dúvidas da equipe a partir do guia da área." },
  ...
  { id: "tarefas",     area: "planejamento", subarea: "Tarefas",       label: "Tarefas", icon: "🗂️", status: "ativo", etapa: "beta",             desc: "Gestor de Tarefas: rotinas e demandas, caixa por usuário, cascatas dos cadastros mestres" },
  ...
  { id: "excecoes",    area: "dp", subarea: "Operação Diária",         label: "Registros de Ponto", icon: "🕐", status: "ativo", etapa: "beta",            desc: "Cruzamento de ponto (Sólides) com Planejamento", dependsOn: ["escala", "pessoas"], oculto: true, descontinuado: true }, // descontinuado — substituído por Análise de Ponto/PTRP; rota mantida, fora do menu e do Config
  { id: "ptrp",        area: "dp", subarea: "Ponto & Jornada",         label: "Ponto (PTRP)",       icon: "⏱️", status: "ativo", etapa: "beta",            desc: "Programa de Tratamento de Registro de Ponto (Portaria 671): conferência/apuração, banco de horas, sincronização das batidas do Sólides, regras (CCT), espelho de ponto e AEJ.", dependsOn: ["escala", "pessoas"] },
  ...
  { id: "chat",        area: "planejamento", subarea: "Minha Central", label: "Minha Central",   icon: "🎛️", status: "ativo", etapa: "em_desenvolvimento", desc: "Tela de abertura de cada usuário: calendário da semana que reúne, por dia, tudo que é seu — avisos, tarefas, prazos, fechamento e checklists — derivado ao vivo dos módulos. Botões de ação por permissão.", dependsOn: ["pessoas"] },
