...
export const MODULES: ModuleDef[] = [
  ...
  { id: "whatsappInbox", area: "ops", subarea: "Gestão da Operação",   label: "WhatsApp",        icon: "💬", status: "ativo", etapa: "em_desenvolvimento", desc: "Caixa de entrada do WhatsApp do planejamento.app — agora dentro da Central de Avisos › WhatsApp", oculto: true },
