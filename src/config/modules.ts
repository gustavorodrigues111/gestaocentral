...
export const MODULES: ModuleDef[] = [
  ...
  { id: "excecoes",         area: "escritorio", label: "Relatório de Exceções", icon: "⚠️", status: "ativo", etapa: "beta",                desc: "Não-conformidades de ponto (Sólides) vs escala prevista", dependsOn: ["escala", "pessoas"] },
