...
export const MODULES: ModuleDef[] = [
  ...
  { id: "beneficios",       area: "escritorio", label: "Benefícios",       icon: "🎁", status: "ativo",     etapa: "beta",               desc: "Lote único de VT (Mobilidade) + VR (Refeição) + auxílio fixo, com 1 CSV pro Caju. Vigente de junho/2026.", dependsOn: ["pessoas", "escala"] },
