...
export type ModuleId =
  ...
  | "horarios" | "seguranca"
  // Time
  | "escala" | "escalaPraticada" | "freelas" | "reunioes" | "trilha" | "ideias" | "planoDeAcao" | "whatsappInbox"
...
export type Restaurant = {
  ...
  eventosConfig?: {
    ...
    // Dados da CONTRATADA (a casa) pra preencher/assinar o contrato de evento.
    dadosContratada?: { razaoSocial?: string; cnpj?: string; endereco?: string; representanteNome?: string; representanteCpf?: string; representanteEmail?: string };
...
// responsaveis = ids dos setores responsáveis pela etapa (pode ser mais de um).
// `responsavel` (singular) fica só p/ retrocompat de dados antigos.
