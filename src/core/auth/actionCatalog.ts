...
export const CATALOGO: CatalogoModulo[] = [
  ...
  },
  {
    ...
    acoes: [
      ...
      { id: "validar",     label: "Validar exceções da minha área (líder) — atrasos", sensivel: true },
  ...
  },
  {
    ...
    area: "gestao",
    acoes: [
      { id: "verConta",         label: "Ver prazos de Financeiro", sensivel: true },
      { id: "gerirConta",       label: "Gerir Financeiro (criar/editar/agendar/resolver)", sensivel: true },
      { id: "verTecnico",       label: "Ver prazos de Operação" },
      { id: "gerirTecnico",     label: "Gerir Operação (criar/editar/agendar/resolver/laudo)" },
      { id: "verTrabalhista",   label: "Ver prazos de Pessoas", sensivel: true },
      { id: "gerirTrabalhista", label: "Gerir Pessoas (criar/editar/agendar/resolver)", sensivel: true },
      { id: "verAvulso",        label: "Ver prazos de Diretoria" },
      { id: "gerirAvulso",      label: "Gerir Diretoria (criar/editar/agendar/resolver)" },
