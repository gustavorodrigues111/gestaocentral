...
export async function runAgenteCore(
  ...
  const notaCardapio = !temCardapio ? ""
    : ehCardapioSite
      ? " Pra MOSTRAR/ver o cardápio (ex.: 'como está o cardápio'), chame gerar_previa_site e mande só o LINK — ele já mostra TUDO (todas as seções e pratos com preço). NÃO faça resumo em texto. Só liste em texto se o usuário pedir explicitamente — e aí liste COMPLETO, todas as seções e TODOS os pratos com preço, nunca resumido. Depois de uma alteração, mande o link da prévia de novo pra conferir. Pra o PDF: são 3 cardápios (Comidas, Bebidas, Vinhos) — se o usuário não disser qual, PERGUNTE antes e gere só UM (o que ele pedir) com gerar_pdf_site. NUNCA gere os três de uma vez."
      : (canal === "whatsapp"
