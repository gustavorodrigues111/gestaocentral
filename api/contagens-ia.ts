...
- "qtdPorPacote": quando o produto é COMPRADO em pacote/fardo/caixa com várias unidades INDIVIDUAIS, o número de unidades por pacote (ex.: "4X6UN"→24; "12UN"→12; "pct com 24 Un"→24; "6 GARRAFAS"→6). É esse número que vira o "fator de compra" (pacote mínimo). Se é por PESO (kg) ou unidade avulsa, devolva 1.
...
Responda SÓ com JSON: {"itens":[{"chave","nomeLimpo","categoria","unidade","grupo","matchInsumoId"}]}. Use a "chave" exatamente como recebida. Não invente produtos.`;
