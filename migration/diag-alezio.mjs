...
const alezio = emps.find(e => /alezio/i.test(e.nome || ""));
if (!alezio) { console.log("Alezio não encontrado"); process.exit(0); }

console.log("=== Alezio workSchedules ===");
console.log(JSON.stringify(alezio.workSchedules, null, 2));
